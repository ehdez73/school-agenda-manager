...
def test_group_subject_hours_must_not_be_consecutive_allows_non_consecutive():
    from restrictions import GroupSubjectHoursMustNotBeConsecutive
...
def test_group_subject_hours_must_not_be_consecutive_blocks_consecutive():
    from restrictions import GroupSubjectHoursMustNotBeConsecutive
