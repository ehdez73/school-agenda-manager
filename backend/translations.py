...
_LOCALES = {
    "en": {
        ...
        "diagnosis.suspect_context_title": "## Context for suspect restrictions",
        "diagnosis.suspect_context_weeklyhours_summary": "- **SubjectWeeklyHours** — {over_capacity} of {total} groups exceed capacity:",
        "diagnosis.suspect_context_weeklyhours_group": "  - {group}: needs {required}h/week but only {available} slots ({days}d × {hours}h)",
        "diagnosis.suspect_context_weeklyhours_group_ok": "  - {group}: OK ({used}/{available} slots)",
        "diagnosis.suspect_context_teacher_one_class": "- **TeacherOneClassAtATime** — {teacher_count} teacher(s) may have concurrent classes:",
        "diagnosis.suspect_context_teacher_one_class_item": "  - {name}: teaches {slots} slot assignments across {days}d; {jc_count} joint class(es) force multi-group presence",
        "diagnosis.suspect_context_unavailable": "- **TeacherUnavailableTimes** — {total} unavailable slots across {teacher_count} teacher(s):",
        "diagnosis.suspect_context_unavailable_item": "  - {name}: {count} unavailable slot(s)",
        "diagnosis.suspect_context_maxhours": "- **TeacherMaxWeeklyHours** — teacher capacity check:",
        "diagnosis.suspect_context_maxhours_item": "  - {name}: effective max {eff}h (base {max}h - {coord}h coord), teaches {load}h across {subj_count} subject(s)",
        "diagnosis.suspect_context_maxhours_warning": "  - {name}: load ({load}h) exceeds effective max ({eff}h)",
        "diagnosis.suspect_context_maxhours_per_day": "- **GroupSubjectMaxHoursPerDay** — subject per-group daily limits:",
        "diagnosis.suspect_context_maxhours_per_day_item": "  - {subject} (id={id}): max {max}h/day, {wh}h/week across {days}d",
        "diagnosis.suspect_context_maxhours_per_day_tight": "    Possibly too restrictive with only {days} day(s) to fit {wh} hours at {max}h/day max",
        "diagnosis.suspect_context_subjectgroup": "- **SubjectGroupAssignment** — {count} subject group(s) active:",
        "diagnosis.suspect_context_subjectgroup_item": "  - {name} (id={id}): {subjects}, shared_hours={shared}",
        "diagnosis.suspect_context_logical_assignment": "- **GroupAtMostOneLogicalAssignment** — {count} subject group(s) with at most one logical unit per group/time slot:",
        "diagnosis.suspect_context_logical_assignment_item": "  - {name} (id={id}): {subjects} ({mode})",
        "diagnosis.suspect_context_joint_class": "- **JointClassAssignment** — {count} joint class(es):",
        "diagnosis.suspect_context_joint_class_item": "  - {name} (id={id}): {subject} for groups {groups} — {mode}, {teacher_info}",
        "diagnosis.suspect_context_consecutive": "- **GroupSubjectHoursMustBeConsecutive** — {count} subject(s) require consecutive hours:",
        "diagnosis.suspect_context_consecutive_item": "  - {name} (id={id}): {wh}h/week, {days}d",
        "diagnosis.suspect_context_not_consecutive": "- **GroupSubjectHoursMustNotBeConsecutive** — {count} subject(s) must NOT have consecutive hours:",
        "diagnosis.suspect_context_not_consecutive_item": "  - {name} (id={id}): {wh}h/week, {days}d",
        "diagnosis.suspect_context_linked": "- **LinkedSubjectsConsecutive** — {count} linked subject pair(s):",
        "diagnosis.suspect_context_linked_item": "  - {a} ↔ {b}",
        "diagnosis.suspect_context_every_day": "- **SubjectMustEveryDay** — {count} subject(s) with teach_every_day=True:",
        "diagnosis.suspect_context_every_day_item": "  - {name} (id={id}): {wh}h/week across {days}d → {min}h/day required",
        "diagnosis.suspect_context_one_subject_per_group": "- **TeacherOneSubjectPerGroup** — teachers teaching multiple subjects to the same group:",
        "diagnosis.suspect_context_one_subject_per_group_item": "  - {name}: teaches {count} subject(s) to group {group} ({subjects})",
        "diagnosis.suspect_context_at_most_one_teacher": "- **GroupSubjectAtMostOneTeacherPerTimeslot** — subjects with multiple qualified teachers:",
        "diagnosis.suspect_context_at_most_one_teacher_item": "  - {subject} (id={id}) in group {group}: {count} qualified teacher(s)",
        "diagnosis.suspect_context_swh_deficit_title": "## Deficit without SubjectWeeklyHours",
        "diagnosis.suspect_context_swh_deficit_item": "  - {name} ({id}): {assigned}h assigned, {required}h required → -{deficit}h",
        "diagnosis.bottleneck_title": "## Bottleneck — relaxing SubjectWeeklyHours by entity",
        "diagnosis.bottleneck_item": "  - **{name}** ({id}) in **{course}**: {wh}h/week (max {mphd}h/day). Relaxing ONLY this subject makes the model feasible.",
        "diagnosis.teacher_bottleneck_title": "## Bottleneck — relaxing TeacherMaxWeeklyHours by entity",
        "diagnosis.teacher_bottleneck_item": "  - **{name}** (id={id}): teaches {load}h across {subj_count} subject(s) in {group_count} group(s), effective max {eff}h (base {max} - {coord}h coord). Relaxing ONLY this teacher makes the model feasible.",
        ...
        "errors.support_already_exists": "A support assignment already exists for this class",
        ...
        "timetable.lective_label": "lective",
        "timetable.coordination_label_short": "coordination",
        "timetable.support_label_short": "support",
        "timetable.joint_class_label": "Joint",
        "timetable.support_label": "SUPPORT",
        "hours.label": "Hour {n}",
        "timetable.teacher_label": "Teacher",
        "timetable.max_label": "Max",
        "timetable.assigned_label": "Assigned",
        "timetable.course_label": "Course",
        "timetable.group_tutor": "Tutor",
        "timetable.hour_header": "Hour",
        "timetable.tab_teacher_staff": "Professors",
    ...
    "es": {
        ...
        "diagnosis.suspect_context_title": "## Contexto de restricciones sospechosas",
        "diagnosis.suspect_context_weeklyhours_summary": "- **SubjectWeeklyHours** — {over_capacity} de {total} grupos exceden capacidad:",
        "diagnosis.suspect_context_weeklyhours_group": "  - {group}: necesita {required}h/semana pero solo {available} espacios ({days}d × {hours}h)",
        "diagnosis.suspect_context_weeklyhours_group_ok": "  - {group}: OK ({used}/{available} espacios)",
        "diagnosis.suspect_context_teacher_one_class": "- **TeacherOneClassAtATime** — {teacher_count} profesor(es) pueden tener clases simultáneas:",
        "diagnosis.suspect_context_teacher_one_class_item": "  - {name}: enseña {slots} asignaciones en {days}d; {jc_count} joint class(es) fuerzan presencia multi-grupo",
        "diagnosis.suspect_context_unavailable": "- **TeacherUnavailableTimes** — {total} franjas no disponibles en {teacher_count} profesor(es):",
        "diagnosis.suspect_context_unavailable_item": "  - {name}: {count} franja(s) no disponible(s)",
        "diagnosis.suspect_context_maxhours": "- **TeacherMaxWeeklyHours** — verificación de capacidad docente:",
        "diagnosis.suspect_context_maxhours_item": "  - {name}: máximo efectivo {eff}h (base {max}h - {coord}h coord), enseña {load}h en {subj_count} asignatura(s)",
        "diagnosis.suspect_context_maxhours_warning": "  - {name}: carga ({load}h) excede el máximo efectivo ({eff}h)",
        "diagnosis.suspect_context_maxhours_per_day": "- **GroupSubjectMaxHoursPerDay** — límites diarios por asignatura y grupo:",
        "diagnosis.suspect_context_maxhours_per_day_item": "  - {subject} (id={id}): máx {max}h/día, {wh}h/semana en {days}d",
        "diagnosis.suspect_context_maxhours_per_day_tight": "    Posiblemente demasiado restrictivo con solo {days} día(s) para encajar {wh} horas a {max}h/día máx",
        "diagnosis.suspect_context_subjectgroup": "- **SubjectGroupAssignment** — {count} grupo(s) de asignaturas activos:",
        "diagnosis.suspect_context_subjectgroup_item": "  - {name} (id={id}): {subjects}, shared_hours={shared}",
        "diagnosis.suspect_context_logical_assignment": "- **GroupAtMostOneLogicalAssignment** — {count} grupo(s) de asignaturas con a lo sumo una unidad lógica por grupo/hora:",
        "diagnosis.suspect_context_logical_assignment_item": "  - {name} (id={id}): {subjects} ({mode})",
        "diagnosis.suspect_context_joint_class": "- **JointClassAssignment** — {count} joint class(es):",
        "diagnosis.suspect_context_joint_class_item": "  - {name} (id={id}): {subject} para grupos {groups} — {mode}, {teacher_info}",
        "diagnosis.suspect_context_consecutive": "- **GroupSubjectHoursMustBeConsecutive** — {count} asignatura(s) requieren horas consecutivas:",
        "diagnosis.suspect_context_consecutive_item": "  - {name} (id={id}): {wh}h/semana, {days}d",
        "diagnosis.suspect_context_not_consecutive": "- **GroupSubjectHoursMustNotBeConsecutive** — {count} asignatura(s) NO deben tener horas consecutivas:",
        "diagnosis.suspect_context_not_consecutive_item": "  - {name} (id={id}): {wh}h/semana, {days}d",
        "diagnosis.suspect_context_linked": "- **LinkedSubjectsConsecutive** — {count} par(es) de asignaturas vinculadas:",
        "diagnosis.suspect_context_linked_item": "  - {a} ↔ {b}",
        "diagnosis.suspect_context_every_day": "- **SubjectMustEveryDay** — {count} asignatura(s) con teach_every_day=True:",
        "diagnosis.suspect_context_every_day_item": "  - {name} (id={id}): {wh}h/semana en {days}d → {min}h/día requeridas",
        "diagnosis.suspect_context_one_subject_per_group": "- **TeacherOneSubjectPerGroup** — profesores que enseñan varias asignaturas al mismo grupo:",
        "diagnosis.suspect_context_one_subject_per_group_item": "  - {name}: enseña {count} asignatura(s) al grupo {group} ({subjects})",
        "diagnosis.suspect_context_at_most_one_teacher": "- **GroupSubjectAtMostOneTeacherPerTimeslot** — asignaturas con múltiples profesores cualificados:",
        "diagnosis.suspect_context_at_most_one_teacher_item": "  - {subject} (id={id}) en grupo {group}: {count} profesor(es) cualificado(s)",
        "diagnosis.suspect_context_swh_deficit_title": "## Déficit sin SubjectWeeklyHours",
        "diagnosis.suspect_context_swh_deficit_item": "  - {name} ({id}): {assigned}h asignadas, {required}h requeridas → -{deficit}h",
        "diagnosis.bottleneck_title": "## Cuello de botella — relajar SubjectWeeklyHours por entidad",
        "diagnosis.bottleneck_item": "  - **{name}** ({id}) en **{course}**: {wh}h/semana (máx {mphd}h/día). Relajar SOLO esta asignatura hace el modelo factible.",
        "diagnosis.teacher_bottleneck_title": "## Cuello de botella — relajar TeacherMaxWeeklyHours por entidad",
        "diagnosis.teacher_bottleneck_item": "  - **{name}** (id={id}): enseña {load}h en {subj_count} asignatura(s) para {group_count} grupo(s), máximo efectivo {eff}h (base {max} - {coord}h coord). Relajar SOLO este profesor hace el modelo factible.",
        ...
        "errors.support_already_exists": "Ya existe un apoyo asignado para esta clase",
        ...
        "timetable.lective_label": "lectivas",
        "timetable.coordination_label_short": "coordinación",
        "timetable.support_label_short": "apoyo",
        "timetable.joint_class_label": "Conjunta",
        "timetable.support_label": "APOYO",
        "hours.label": "Hora {n}",
        "timetable.teacher_label": "Profesor",
        "timetable.max_label": "Máx",
        "timetable.assigned_label": "Asig",
        "timetable.course_label": "Curso",
        "timetable.group_tutor": "Tutoría",
        "timetable.hour_header": "Hora",
        "timetable.tab_teacher_staff": "Profesorado",
