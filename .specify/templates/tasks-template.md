...
**Tests**: Include test tasks for every behavior or contract change. Tests are REQUIRED by constitution principles.
...
- [ ] T004 Add/update baseline test scaffolding needed for test-first execution
